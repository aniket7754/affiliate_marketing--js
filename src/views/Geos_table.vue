                                ...
                                <table id="campaignsview"
                                    ...
                                    <thead class="table-bg text-center ">
                                        ...
                                        <tr class=" border-bottom-0">
                                            ...
                                            <th class="wd-15p text-center">Country Name</th>
                                            <th class="wd-15p text-center">Offers</th>
...
export default {
    ...
    mounted() {
        fetch(`http://localhost:8080/api/v1/top_5_country?start_date=2023-01-01&end_date=2023-01-03&pub_name=savtarr`)
